...
public class ForLoop {
	...
	public static void main(String[] args) {
		 ...
		 * for(inicializacion; condición; contador(incremento/decremento){ bloque de
		 * código {
		 */
		 ...
		 * 
		 * Imprimir uan forma triangular de asteriscos
		 */
		...
		/*
		 * Output: El elevado a la 1 potencial es igual a 3.141592653589793 PI elevado a
		 * la 2 potencia es igual a ....
		 */
